function hmri_mz_from_MPG_WLS2
% PURPOSE
...
hmri_def.scanner = 'terra' ; % e.g. 'prisma', 'allegra', 'terra', 'achieva', ...
...
hmri_def.coreg_flags.sep=[4 2 1 0.6];
...
hmri_def.coreg_bias_flags.mask_options.domask = true; % whether to mask the B1ref image before registration
...
% 8) Test tags for Solene data
hmri_def.MPMacq_set.names{8} = 'Imperfect_spoiling_calc_ver0';
hmri_def.MPMacq_set.tags{8}  = 'Imperfect_spoiling_calc_ver0';
hmri_def.MPMacq_set.vals{8}  = [19.5         19.5            5           20];
% 9) Kerrin tags for Ironsleep data
hmri_def.MPMacq_set.names{9} = 'Dynamic_pTx_0p6';
hmri_def.MPMacq_set.tags{9}  = 'Dynamic_pTx_0p6';
hmri_def.MPMacq_set.vals{9}  = [22.4         22.4            7           22];
...
% 8) Test for Solenes data
hmri_def.imperfectSpoilCorr.Imperfect_spoiling_calc_ver0.tag = 'Imperfect_spoiling_calc_ver0';
hmri_def.imperfectSpoilCorr.Imperfect_spoiling_calc_ver0.P2_a = [32.0744     -39.0043       20.364];
hmri_def.imperfectSpoilCorr.Imperfect_spoiling_calc_ver0.P2_b = [-0.0831      0.0683      0.9781];
hmri_def.imperfectSpoilCorr.Imperfect_spoiling_calc_ver0.small_angle_approx = true;
