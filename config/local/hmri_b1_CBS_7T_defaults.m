function hmri_b1_CBS_7T_defaults
...
%
% Edited by ledwards@cbs.mpg.de 2019 to include standard in vivo 7T 
% protocol at MPI-CBS
%__________________________________________________________________________
...
hmri_def.b1map.i3D_AFI.b1acq.alphanom = 55;
...
hmri_def.b1map.i3D_EPI.b1proc.nAmbiguousAngles = 3; % how many [90*(n-1),90+90*(n-1)] degree ranges to test to overcome acos ambiguity. Minimum of 2, more than 3 probably not needed for reasonable SE/STE flip angle pairs.
hmri_def.b1map.i3D_EPI.b1proc.HZTHRESH = 190;
%hmri_def.b1map.i3D_EPI.b1proc.HZTHRESH = 590; % For tuneup shims
hmri_def.b1map.i3D_EPI.b1proc.SDTHRESH = 6;
